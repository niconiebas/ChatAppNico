import 'package:chatappnotification/Components/chat_bubble.dart';
...
// wait a bit for listview to be built, then scroll to botom
    Future.delayed(
      const Duration(milliseconds: 500),
      () => scrollDown(),
    );
  ...
  void sendMessage() async {
    // if there is something inside the textield
  ...
  Widget _buildMessageList() {
    String senderID = _authService.gerCurrentUser()!.uid;
  ...
  Widget _buildMessageItem(DocumentSnapshot doc) {
    ...
    // is current user
    bool isCurrentUser = data['senderID'] == _authService.gerCurrentUser()!.uid;
